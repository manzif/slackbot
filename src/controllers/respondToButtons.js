...
const respondToAntiRacismButton = (selectedOption, respond) => {
...
const respondToAntiSexismButton = (selectedOption, respond) => {
...
const respondToLgbtqAllyshipButton = (selectedOption, respond) => {
...
const respondToAutismAllyshipButton = (selectedOption, respond) => {
